...
<html lang="en">
<head>
    {{--TODO API для обработки запроса от заказа--}}
    {{--TODO Почтовая рассылка--}}
    {{--TODO Рахобраться с фреворком для отображения пригыющих цифр(сотри закладки)--}}
    {{--TODO Блок успешного заказа, обнуление корзины--}}
    <meta charset="UTF-8">
